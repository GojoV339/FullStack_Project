...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 h-screen w-64 flex-col glass border-r border-white/10 z-40">
      ...
      <div className="p-4 border-t border-white/10">
        <motion.button
          ...
          className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-white/50 hover:text-white/80 hover:bg-white/5 transition-colors"
          whileTap={{ scale: 0.97 }}
        >
          <LogOut size={20} />
